      ...
      <div className="timeLine">
        <div className="container clock">
          <div className="text-box left-container">
            ...
            <h3 className="card-subtitle"><a href="https://www.facebook.com/groups/1508297279476266/" target="_blanck">D.B. Ghumare Public School,Beed</a></h3>
        ...
        <div className="container antiClock">
          ...
          <img src="/images/md.png" alt="" className="left-container-img" />
            ...
            <h3 className="card-subtitle"><a href="https://moderncollegepune.edu.in/" target="_blanck">MCASC, Shivajinagar Pune-05</a></h3>
        ...
        <div className="container clock">
          ...
          <img src="/images/pes.jpg" alt="" className="right-container-img"/>
            ...
            <h3 className="card-subtitle"><a href="http://pescoe.ac.in/" target="_blanck">P.E.S College of
            Engineering, Aurangabad</a></h3>
        ...
        <div className="container antiClock">
          <div className="text-box right-container">
          <img src="/images/naresh.jpg" alt="" className="left-container-img"/>
            <h2 className="card-title">Course</h2>
            <h3 className="card-subtitle"><a href="https://www.nareshit.in/course-schedule/" target="_blanck">Naresh IT(MERN Stack)</a></h3>
